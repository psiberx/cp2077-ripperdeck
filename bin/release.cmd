...
@set WorkDir=%CD%
@set DistDir=D:\Projects\Cyberpunk\RipperDeck\dist

@set ModPath=bin\x64\plugins\cyber_engine_tweaks\mods\RipperDeck
...
@set ReleaseZip=%DistDir%\RipperDeck-%Version%.zip
